...
import { NoteDatabase } from 'src/infra/typeorm/repositories/DatabaseControl'
...
class RouterNotes {
    ...
    public static async create(req: Request, res: Response){
        ...
        try {
            ...
            await NoteDatabase.create({note: note, title: title, user: user, createdAt: data.toString(), updated_at: ''})
